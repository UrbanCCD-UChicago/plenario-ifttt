...
from plenario_ifttt.views import nearest, alert, node_options, feature_options
...
urlpatterns = [
    ...
    url(r'^ifttt/v1/triggers/nearest/fields/feature/options', feature_options),
    url(r'^ifttt/v1/triggers/nearest', nearest),
]
